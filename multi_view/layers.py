...
class Layers:
    ...
    def scale_proportionally_to_certainty(self, n_components, scaler=None):
        scaled = {}
        ...
        nmf = MultiViewNMF(max_iter=50, n_components=n_components)
        ...
        for key, value in self.layers.items():
            ...
            # multiplication values be certainty leads to..
